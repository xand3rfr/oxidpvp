...
(() => {
  ...
  const GAMES = [
    ...
    { id: "typing", page: "typing", title: "Type Race", min: 1, max: 8 },
    ...
    { id: "racing", page: "racing", title: "Kart Racing", min: 1, max: 6 },
  ...
  const ACHIEVEMENTS = [
    ...
    { id: "sudoku", icon: "🔢", name: "Number cruncher", desc: "Solve a Daily Sudoku", special: true },
    { id: "puzzle", icon: "♞", name: "Tactician", desc: "Solve a Daily Chess puzzle", special: true },
